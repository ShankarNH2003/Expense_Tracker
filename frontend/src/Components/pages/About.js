    ...
    <AboutStyled bgImage={currentBg}>
      ...
      <div style={styles.container}>
        <div style={styles.content}>
          <h1 style={styles.title}>About ExpenseTracker</h1>
          <p style={styles.paragraph}>
            ExpenseTracker is designed to help users take control of their finances.  
            Track your expenses, manage budgets, and gain financial insights in one place.
          </p>
        </div>
      </div>
      <Footer/>
